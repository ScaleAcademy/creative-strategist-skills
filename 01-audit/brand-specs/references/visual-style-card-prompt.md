# Visual Style Card — HTML Prompt

Use this prompt after generating `brand-research-brief.json`. The output is an HTML page to screenshot as `visual-style-card.png`.
